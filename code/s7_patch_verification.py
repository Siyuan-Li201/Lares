...
sys.path.append("code/code/patch_verification")
sys.path.append("code/code/llm_location")
...
def get_eqs_z3(source_dict, pseudo_dict):
    ...
    filtered_sig = json.load(open("code/z3_sig_filter.json", "r"))
...
if __name__ == "__main__":
    patch_verification("code/data")

    patch_verification_z3("code/data", "code/tmp")


    # filter_sig_z3("code/data", "code/tmp")


    patch_verification_result_z3("code/data")