...
sys.path.append("code/code/get_patch_function/source_code_extract")
...
def source_preprocess_main(xlsx_file, patch_path, source_path, tmp_path, res_save_path):
    # Read all .json files in the patch_path
    json_files = [f for f in os.listdir(patch_path) if f.endswith('.json')]
...
if __name__ == '__main__':
    ...
    #     sys.exit(1)
    xlsx_file = "code/dataset/patch/cve_data.xlsx"
    patch_path = "code/dataset/patch/sig"   #sys.argv[1]
    source_path = "code/dataset/source"     #sys.argv[2]
    tmp_path = "code/tmp"   #sys.argv[3]
    res_save_path = "code/data"     #sys.argv[4]
    src_path = "code/dataset/patch/src"

    
    source_preprocess_main(xlsx_file, patch_path, source_path, tmp_path, res_save_path)
