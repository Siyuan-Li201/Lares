        ...
        for cve_dir_name in tqdm(os.listdir(data_dir)):
            ...
            if len(patch_result_dir_list) > 0:
                for patch_result_dir in patch_result_dir_list:
                    ...
                    more_patch_result_file_list = glob.glob(os.path.join(patch_result_dir, "4o10_llm_res*.txt"))

                    if len(more_patch_result_file_list) == 1:      
                        patch_result_file = os.path.join(patch_result_dir, "4o10_llm_res_1.txt")
...
merge_csv_files('output_z3_filtered.csv', 'output_llm.csv', 'output.csv')
