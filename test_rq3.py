...
if __name__ == "__main__":
    ...
    # Put binaries from cross-opti in code/dataset/bin to test RQ3 (Ablation Evaluation)
    binaries_cross_opti_path = ""
    shutil.copy(binaries_cross_opti_path, "code/dataset/bin")
    ...
    # Step3. patch verification module (Ablation Evaluation)
    # The result for $Lares_{-z3}$ (Ablation Evaluation)
    s7_patch_verification.patch_verification(data_directory)
    # The result for $Lares_{-pl}$ (Ablation Evaluation)
    s7_patch_verification.patch_verification_z3(data_directory, "code/tmp")
    # The result for $Lares_{-pv}$ (Ablation Evaluation)
